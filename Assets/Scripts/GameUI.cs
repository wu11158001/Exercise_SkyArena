...
public class GameUI : MonoBehaviour
{
    ...
    void OnChallengeBossButtonFunction()
    {
        ...
        AudioManagement.Instance.audioSource.clip = AssetManagement.Instance.OnSearchAssets<AudioClip>("ChallengeBossMusic", AssetManagement.Instance.backgroundMusic);
